...
(function () {
    ...
    try {
        (function() {
            ...
            // --- ДАННЫЕ О РАЗДЕЛАХ (из первого скрипта) ---
            const DATA_TECH = [
            ...
            function createHeaderButtons() {
                ...
                // Функция создания кнопки (стиль из второго скрипта)
                ...
                // Кнопка IP (функционал из второго скрипта)
            ...
            style.textContent = `
                ...
                /* Стили для модального окна настроек из первого скрипта */
                .fnp-modal-overlay {
                    position: fixed;
                    top: 0;
                    left: 0;
                ...
                /* Стили для модального окна IP (из второго скрипта) */
                .ip-modal {
                    display: none;
                    position: fixed;
                    z-index: 10000;
            ...
            // --- Функции для работы с IP (из второго скрипта) ---
            ...
            const observer = new MutationObserver(() => {
                if (!document.querySelector('.br-header-buttons-container')) {
                    createHeaderButtons();
                }
            });
