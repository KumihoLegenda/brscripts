(function () {
    ...
    try {
        (function() {
            // Весь блок const STORAGE_PREFIX, DATA_TECH, DATA_TECH_COMPLAINT, 
            // DATA_PLAYER_COMPLAINT, OPS_LINK, SERVER_LIST, 
            // функции getSelected, renderMenu, openSettings, 
            // создание wrapper, toggleBtn, menu, стили fnp-* и т.д. 
            // ПОЛНОСТЬЮ УДАЛЁН
        })();
  ...
  const ODOBRENO_PREFIX = 8; // префикс одобрено
	...
	// const DECIDED_PREFIX = 6; // префикс решено - УДАЛЁН
...
},
{
  ...
  status: false
	...
	// addButton('Решено', 'decided', ...) - УДАЛЁН
