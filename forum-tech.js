    ...
    function initializeScript() {
        if (window.location.href.includes('threads')) {
            ...
            $(document).ready(() => {
                ...
                addButton('На рассмотрении', 'pin', 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 165, 0, 0.8);');
                addButton('КП', 'odobreno', 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 255, 0, 0.8);');
