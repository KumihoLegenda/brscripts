...
// @updateURL https://update.greasyfork.org/scripts/487756/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%81%D0%B8%D1%81%D1%82%D0%B5%D0%BC%D1%8B%20%D0%BB%D0%BE%D0%B3%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F%20%2B%20TradeID%20Viewer.user.js
// @updateURL https://update.greasyfork.org/scripts/487756/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%81%D0%B8%D1%81%D1%82%D0%B5%D0%BC%D1%8B%20%D0%BB%D0%BE%D0%B3%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F%20%2B%20TradeID%20Viewer.user.js
// ==/UserScript==
...
(function () {
    ...
    // Исправленная функция для кнопок трейдов - как во втором скрипте
    ...
    // Исправленная функция для обменов транспорта
        ...
        document.querySelectorAll('tr.second-row').forEach(row => {
            ...
            if (categoryCell?.textContent === 'Личное транспортное средство' && transactionCell) {
                ...
                if ((transactionDesc.includes('+ Доплата за обмен от') ||
                    ...
                    const btn = document.createElement('button');
                    btn.className = 'trade-btn-resp vehicle-btn';
    ...
    // Исправленная функция для IP кнопок
    ...
    GM_addStyle(`
        ...
        .trade-btn-resp.vehicle-btn {
            background: var(--secondary-gradient);
        }
        .trade-btn-resp.vehicle-btn:hover {
            transform: translateY(-2px);
